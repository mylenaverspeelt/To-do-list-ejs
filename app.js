...
const data = require(__dirname + "/date.js")   //como é um modulo local ai coloca o dirname
const app = express()
...
const dia = data.getDate()   //modulo local que informa a data
...
app.post("/", function (req, res) {
    ...
    const inputUsuario = req.body.inputUsuario;
...
app.post("/work", function(req, res){
    const inputUsuarioWork = req.body.inputUsuarioWork
